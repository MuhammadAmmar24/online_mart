...
from app.models.inventory_model import InventoryItem, UpdateInventoryItem
...
def update_inventory_item(id: int, to_update_inventory_data: UpdateInventoryItem, session: Session) -> InventoryItem:
